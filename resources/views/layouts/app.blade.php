...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-base-200 text-neutral">
        ...
        @if (session('success') || session('error'))
            <div 
                ...
                class="fixed bottom-5 right-5 z-50 rounded-lg shadow-2xl p-4 flex items-center gap-3 text-white font-semibold {{ session('success') ? 'bg-success' : 'bg-error' }}">
