<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-base-100 p-6 rounded-xl shadow-lg">
                    ...
                    {{-- FIX: Bungkus canvas dengan div yang memiliki tinggi spesifik dan posisi relatif --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Mengambil data dinamis dari Blade
            ...
            // Fungsi untuk mendapatkan warna dari CSS Variables yang sudah di-parsing
            const getComputedColor = (variable) => {
                // Ambil nilai HSL dari root, contoh: '255 69% 65%'
            ...
            const borrowingChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        pointBorderColor: `hsl(${getComputedColor('--base-100')})`,
                        pointHoverBackgroundColor: `hsl(${getComputedColor('--base-100')})`,
            ...
            // Menggunakan MutationObserver untuk keandalan
            new MutationObserver(() => {
                ...
                borrowingChart.data.datasets[0].pointBorderColor = `hsl(${getComputedColor('--base-100')})`;
                borrowingChart.data.datasets[0].pointHoverBackgroundColor = `hsl(${getComputedColor('--base-100')})`;
