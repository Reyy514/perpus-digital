                                    ...
                                    <div class="relative flex items-start gap-4">
                                        ...
                                        <div class="absolute left-5 top-1 -translate-x-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-base-200 ring-4 ring-base-100">
                                            ...
                                            @elseif($log->type == 'book_borrowed')
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-check text-info"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/><path d="m9 13 2 2 4-4"/></svg>
